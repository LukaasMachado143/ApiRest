    ...
    public class EventoRepository : IEventoRepository
    {
        ...
        public async Task<IEnumerable<EventoModel>> GetAllEvents()
        {
            ...
            catch (Exception e)
            {
                ...
                _log.LogError($"Error when trying acessing database for search all events. (Repository) | Error:{e}");
                throw;
            }
        }
        ...
        public async Task<IEnumerable<EventoModel>> GetEventById(int id)
        {
            ...
            {
                _log.LogInformation($"Error when trying acessing database for search Event by id. (Repiository) | Error:{e}");
                throw;
            }
        }
        ...
        public async Task AddEvent(EventoModel evento)
        {
            ...
            catch (Exception e)
            {
                ...
                _log.LogError($"Error when trying register a new event in to the database.(Repository) | Error:{e}");
                throw;
            }
        }
        ...
        public async Task UpdateDataEvent(EventoModel evento)
        {
            ...
            catch (Exception e)
            {
                ...
                _log.LogError($"Error when trying Changing data of event in to the database.(Repository) | Error:{e}");
                throw;
            }
        }
        public async Task RemoveEvent(EventoModel evento)
        {
            ...
            catch (Exception e)
            {
                ...
                _log.LogError($"Error when trying Removing event in to the database.(Repository) | Error:{e}");
                throw;
            }
        }
    }
